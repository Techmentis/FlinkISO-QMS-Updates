		...
		<table cellpadding="0" cellspacing="0" class="table table-bordered table table-striped table-hover">
			...
			<?php if($qcDocumentCategories){ ?>
				<?php foreach ($qcDocumentCategories as $qcDocumentCategory): ?>
					<tr>
						<td width="15"><?php echo $this->Form->checkbox('rec_ids_'.$i,array('label'=>false,'value'=>$qcDocumentCategory['QcDocumentCategory']['id'],'multiple'=>'checkbox','class'=>'rec_ids')); ?></td>		<td class=" actions">
							<div class="btn-group">
							...
							<ul class="dropdown-menu" role="menu">
								<li><?php echo $this->Html->link(__('View / Upload Evidance'), array('action' => 'view', $qcDocumentCategory['QcDocumentCategory']['id'])); ?></li>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<?php echo $this->Form->create('qcDocumentCategories',array('action'=>'report','target'=>'_blank','class'=>'no-padding no-margin no-background zero-height'));?>
