    ...
    <div class="nav panel panel-default">
        <div class="users form col-md-12">            
            <div class="row">
                ...
                <div class="col-md-4"><?php echo $this->Form->input('employee_id', array('style' => 'width:100%', 'class' => 'form-control', 'label' => __('Employee'), 'options' => $PublishedEmployeeList)); ?></div>
            ...
            <div class="row">
                ...
                <div class="col-md-4"><?php echo $this->Form->input('is_view_all', array('label' => __('User who can see other user\'s records'))); ?></div>
            </div>
            <?php                      
