...
<?php echo $this->fetch('script'); ?><div id="designations_ajax">
	...
	<div class="designations ">
		...
		// echo "<div class='col-md-4'>".$this->Form->input('level',array('class'=>'form-control',)) . '</div>'; 
		// echo "<div class='col-md-4'>".$this->Form->input('division_id',array('class'=>'form-control', 'style'=>'')) . '</div>'; 
					?>
					<?php
		...
		<script>
			...
			$().ready(function() {
				...
				$("#submit_id").click(function(){
					if($('#DesignationAddForm').valid()){
						$("#submit_id").prop("disabled",true);
						$("#submit-indicator").show();
						$('#DesignationAddForm').submit();
					}
