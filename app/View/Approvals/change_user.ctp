...
<div id="main">
    ...
    <div class="nav">
        <div class="branches form <?php echo !empty($this->request->params['named']['modal']) ? 'col-md-12' : 'col-md-8'; ?>">
            <?php if (empty($this->request->params['named']['modal'])) { ?><h4><?php echo __("Change Approver"); ?></h4><?php } ?>
            ...
            <?php echo $this->Form->submit(__(!empty($this->request->params['named']['modal']) ? 'Change' : 'Submit'), array('div' => false, 'class' => 'btn btn-primary btn-success', 'update' => '#branches_ajax', 'async' => 'false','id'=>'submit_id')); ?>
