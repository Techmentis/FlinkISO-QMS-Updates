...
<div class="branches ">
	...
	<p><strong>Note : </strong>If you are a creator of the record, you can direclty access those records from that record's listing page. This page will only list records which are not created by you.</p>
	<div class="table-responsive"> <?php echo $this->Form->create(array('class' => 'no-padding no-margin no-background')); ?>
		<table cellpadding="0" cellspacing="0" class="table table-bordered table table-striped table-hover">
			...
			if ($approvals) {
				...
				<tr>
					<td colspan="8"><?php echo __('No results found'); ?></td>
				</tr>
			<?php } ?>
		</table>
