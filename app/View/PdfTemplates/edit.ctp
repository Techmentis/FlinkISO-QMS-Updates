...
<style type="text/css">
	...
	.small-title .box-title{font-size: 100% !important}
</style>
...
<div class="main">
	...
	<div class="col-md-12 col-lg-3 small-title">
		<div class="box box-default collapsed-box">
			<div class="box-header data-header" data-widget="collapse">
				<h3 class="box-title"><?php echo $this->request->data['CustomTable']['table_name'];?></h3>
			...
			<div class="box-footer">
				Copy-Paste fields from above in a document where you want the values to be displayed
			</div>
		</div>
		<div class="box box-default collapsed-box">
			<div class="box-header data-header" data-widget="collapse">
				<h3 class="box-title">QC Document</h3>
					<div class="box-tools pull-right">
						<button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-plus"></i></button>
				</div>
			</div>
		...
		<?php foreach($linkedTosFields as $model => $fields){ ?>
			<div class="box box-default collapsed-box">
			<div class="box-header data-header" data-widget="collapse">
				<h3 class="box-title"><?php echo $model;?></h3>
					<div class="box-tools pull-right">
						<button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-plus"></i></button>
				</div>
			</div>
	...
	if($existingChildTables){
		foreach($existingChildTables as $childTables){ 
			...
			<div class="box box-default collapsed-box">
				<div class="box-header data-header" data-widget="collapse">
					<h3 class="box-title"><?php echo $childTable['CustomTable']['table_name'];?></h3>
						<div class="box-tools pull-right">
							<button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-plus"></i></button>
						</div>
					</div>
					<div class="box-body">
						<div class="panel-body childtables">
							<ul id="<?php echo $childTable['CustomTable']['table_name'];?>">							
								<?php foreach($childTable['CustomTable']['fields'] as $cmainField){
									if($cmainField)echo  '<li class="ui-state-default">'.$cmainField .'</li>';
								}									
								?>							
							</ul>
					</div>
		...
		foreach($childTables as $childTable){ ?>
			<div class="box box-default collapsed-box">
				...
				<div class="box-body childtables">
					<ul id="<?php echo $childTable['CustomTable']['table_name'];?>">							
						<?php foreach(json_decode($childTable['CustomTable']['fields'],true) as $cmainField){
							echo  '<li class="ui-state-default">'.$cmainField['field_name'] .'</li>';
						}									
						?>							
					</ul>
				</div>
		...
		<div class="col-md-12">
			<?php 
			echo $this->Form->submit('Save Template',array('class'=>'btn btn-lg btn-info pull-left'));
			echo $this->Form->end();
			?>	
		</div>
	</div>
