...
<div class="row">
	...
	$nextAction = isset($this->request->params['named']['next_action']) ? $this->request->params['named']['next_action'] : '';
	echo '<div class="col-md-4 hide">'.$this->Form->hidden('next_action',array('type'=>'hidden', 'default'=>$nextAction, 'class'=>'form-control')).'</div>';
