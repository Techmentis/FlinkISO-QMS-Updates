...
<div class="custom_tables">
    <h4>Reports <small>(Beta)</small></h4>
    <div id='manualcharttabs'>
        ...
        <div id="intro"><i class="fa fa-pie-chart fa-5x pull-left" style="color:#00c0ef"></i><h3>Click on <strong>Add Chart</strong> to create new chart</h3></div>
    </div>
