<div class="box box-danger">
  <div class="box-header " style="background-color: #fefefe; border-bottom: 1px dotted #ccc;">
    <h3 class="box-title"><i class="fa fa-info-circle fa-lg pull-left text-danger"> </i> Pending Actions</h3>
  ...
  <div class="box-body" >
    ...
    $txt2 = $txt3 = $txt4 = '';
    $show = true;
    if($masters['User']['branches'] == 1 || $masters['User']['departments'] == 1 || $masters['User']['designations'] == 1 || $masters['User']['employees'] == 1 || $masters['User']['users'] == 1){
      $class2 = 'danger';
      $class3 = 'danger';
      $class4 = 'danger';  
    ...
    }else if($masters['User']['qc_documents'] == 1){
      $class2 = 'success';
      $class3 = 'danger';
      $class4 = 'danger';  
      ...
      $txt4 = 'Pending : Build Custom Tables.';  
    }else if($masters['User']['custom_tables'] == 1){
      $class2 = 'success';
      $class3 = 'success';
      $class4 = 'danger';
      $txt2 = 'Masters are ready.'; 
          ...
          <div class="col-md-12">
            <div class="row">
              <div class="col-md-5">
                ...
                <p>In order to setup and start using the application, you must add branches/ departments/ employees/ designations/ stardards & clauses/ documents etc. Follow these step-by-step guilde below to kick start your QMS implementation.</p>
                <ul>          
              ...
              <div class="col-md-3">
                <h4>Ready Modules</h4>  
                <p>We have ready modules available to download. However to access these modules you must add documents first. Once the documents are added you can install these modules one-by-one:</p>              
                <ul>
                  ...
                  <li><a href="https://www.flinkiso.com/quality-management-software/non-conformities.html" title="Non Conformities" target="_blank">Non Conformities</a></li>
    ...
    <div class="box-footer">
      ...
      <a href="https://www.flinkiso.com/services/startup-plan.html" target="_blank" class="text-blue"><h5 class="pull-right"><i class="fa fa-bolt fa-lg"></i> Try our new Start-Up Plan</h5></a>
    </div>
  </div>
</div>