		...
		<div class="nav panel panel-default">
			<div class="branches form col-md-12">
				...
				<div class="row">
					...
					echo "<div class='col-md-12'>". $this->Form->input('departments',array('name'=>'data[Branch][departments][]', 'type'=>'select', 'selected'=>json_decode($this->data['Branch']['departments'],true), 'options'=>$PublishedDepartmentList,'multiple')) . '</div>'; 
					?>
					<?php
