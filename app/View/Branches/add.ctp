      ...
      <div class="nav panel panel-default">
        <div class="branches form col-md-12">
           ...
           <div class="row">
             ...
             echo "<div class='col-md-12'>". $this->Form->input('departments',array('name'=>'data[Branch][departments][]', 'type'=>'select', 'options'=>$PublishedDepartmentList,'multiple')) . '</div>'; 
             ?>
             <?php
