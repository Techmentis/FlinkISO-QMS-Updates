						...
						<tr class="<?php echo $revisionClasss;?>" onclick="addrec('<?php echo $qcDocument['QcDocument']['id'];?>')" id="<?php echo $qcDocument['QcDocument']['id'];?>_tr">
							<td>
								...
								<td width="60">
									...
									<?php if($qcDocument['children']){
										foreach($qcDocument['children'] as $childDoc){ ?>
											<tr class="childdoc" onclick="addrec('<?php echo $childDoc['QcDocument']['id'];?>')" id="<?php echo $childDoc['QcDocument']['id'];?>_tr">
												<td><i class="fa fa-angle-right" style="margin: 0px 10px;"></i>
													...
													<strong><?php echo $this->Html->link($childDoc['Standard']['name'], array('controller' => 'standards', 'action' => 'view', $childDoc['Standard']['id'])); ?></strong>: <strong><?php echo $this->Html->link($childDoc['QcDocument']['title'],array('action'=>'view',$childDoc['QcDocument']['id'])); ?>&nbsp; </strong> - <small><?php echo h($childDoc['QcDocument']['document_number']); ?>&nbsp;</small></td>
