<head>
    <style type="text/css">
        ...
        .logo{background-color:#0094ff; width:120px; padding: 12px 12px; font-size: 16px; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; color:#fff; display: block;}
