...
<html>
    ...
    <body>
        <div style='float:left;width:99%; display:block;padding:2px;margin:2px;'>
            ...
            <div style='background:#16AFDD;margin:0px; float:left; padding:0; border-bottom:1px dashed #FFFFFF; color:#fff; width:100%; text-shadow:0px 0px 1px #000000; line-height:19px'><h2 style='padding-left:20px'>New Objective Assigned</h2>
            </div>
