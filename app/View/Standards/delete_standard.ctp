...
<div class="row">
	...
	echo '<div class="col-md-4">'.$this->Form->input('password',array('class'=>'form-control')).'</div>';
	echo '<div class="col-md-12"></div>';
	echo '<div class="col-md-12"><p class="text-danger"><strong>This will delete this standard, clauses, documents. custom tables under this standard needs to be deleted desperately. </strong><br />Record once deleted can not be retrieved. Are you sure you want to continue?</p></div>';
