...
public $belongsTo = array(
	'ParentTable' => array(
		...
		'conditions' => '',
		'fields' => array('id', 'name', 'title','document_number','revision_number','file_type','departments','branches','user_id','schedule_id', 'data_type','data_update_type', 'publish','parent_document_id','standard_id'),
		'order' => ''
	),'Process' => array(
		'className' => 'Process',
